...
[_BL] = LAYOUT_ansi(
   ...
   * |      |<- |Dn | ->|   |   |   |   |   |   |   |   |        |Hom |
   * |----------------------------------------------------------------|
   * |        |   |   |Bl-|BL |BL+|BLB|VU-|VU+|MUT|   |      |   |End |
   * |----------------------------------------------------------------|
   * |    |    |    |                       |   |   |    |   |   |    |
   * `----------------------------------------------------------------'
   */
[_FL] = LAYOUT_ansi(
  _______, KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_ESC,  \
  ...
  _______,          _______, _______,  BL_DEC,  BL_TOGG, BL_INC,  BL_BRTG, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______, KC_END,  \
